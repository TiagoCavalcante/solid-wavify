...
function $6ad09188ba6eae36$export$2e2bcd8739ae039(baseProps) {
    ...
    return (()=>{
        ...
        (0, $83Duu$solidjsweb.use)((element)=>{
            if (local.ref) {
        ...
        (0, $83Duu$solidjsweb.spread)(_el$3, (0, $83Duu$solidjsweb.mergeProps)({
            get d () {
                return path();
            },
            get fill () {
...
function $9233cea927cb9637$export$2e2bcd8739ae039(props) {
    return (0, $83Duu$solidjsweb.createComponent)((0, $6ad09188ba6eae36$export$2e2bcd8739ae039), (0, $83Duu$solidjsweb.mergeProps)($9233cea927cb9637$var$defaults, ()=>props.options, props));
}
