...
const $6ad09188ba6eae36$var$_tmpl$ = /*#__PURE__*/ $83Duu$solidjsweb.template(`<div><svg width="100%" height="100%" version="1.1" xmlns="http://www.w3.org/2000/svg"><path></path></svg></div>`, 6);
function $6ad09188ba6eae36$export$2e2bcd8739ae039(baseProps) {
    const props = $83Duu$solidjs.mergeProps({
        amplitude: 20,
        height: 20,
        points: 3,
        speed: 0.15
    }, baseProps);
    const [local, rest] = $83Duu$solidjs.splitProps(props, [
        "amplitude",
        "height",
        "points",
        "speed",
    ...
    return (()=>{
        ...
        $83Duu$solidjsweb.insert(_el$2, ()=>local.children
        , _el$3);
        $83Duu$solidjsweb.spread(_el$3, rest, true, false);
        $83Duu$solidjsweb.effect((_p$)=>{
            const _v$ = {
                width: '100%',
                display: 'inline-block',
                ...local.style
            }, _v$2 = local.className, _v$3 = local.id, _v$4 = path(), _v$5 = local.fill;
            _p$._v$ = $83Duu$solidjsweb.style(_el$, _v$, _p$._v$);
            _v$2 !== _p$._v$2 && (_el$.className = _p$._v$2 = _v$2);
            _v$3 !== _p$._v$3 && $83Duu$solidjsweb.setAttribute(_el$, "id", _p$._v$3 = _v$3);
            _v$4 !== _p$._v$4 && $83Duu$solidjsweb.setAttribute(_el$3, "d", _p$._v$4 = _v$4);
            _v$5 !== _p$._v$5 && $83Duu$solidjsweb.setAttribute(_el$3, "fill", _p$._v$5 = _v$5);
            return _p$;
        }, {
            _v$: undefined,
            _v$2: undefined,
...
function $9233cea927cb9637$export$2e2bcd8739ae039(props) {
    ...
    return $83Duu$solidjsweb.createComponent($6ad09188ba6eae36$export$2e2bcd8739ae039, $83Duu$solidjsweb.mergeProps({
        get fill () {
            return local.fill;
        },
        get paused () {
    ...
    }, $9233cea927cb9637$var$defaults, ()=>local.options
    , rest));
}
