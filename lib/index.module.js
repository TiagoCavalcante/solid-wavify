import {createComponent as $9Ue0q$createComponent, mergeProps as $9Ue0q$mergeProps, template as $9Ue0q$template, use as $9Ue0q$use, insert as $9Ue0q$insert, spread as $9Ue0q$spread, effect as $9Ue0q$effect, style as $9Ue0q$style, className as $9Ue0q$className, setAttribute as $9Ue0q$setAttribute} from "solid-js/web";
import {mergeProps as $9Ue0q$mergeProps1, splitProps as $9Ue0q$splitProps, createSignal as $9Ue0q$createSignal, onMount as $9Ue0q$onMount, onCleanup as $9Ue0q$onCleanup} from "solid-js";
...
function $6719f9210d2bc6ba$var$isFunction(obj) {
...
function $6719f9210d2bc6ba$export$2e2bcd8739ae039(baseProps) {
    ...
    return (()=>{
        ...
        (0, $9Ue0q$use)((element)=>{
            if (local.ref) {
                if ($6719f9210d2bc6ba$var$isFunction(local.ref)) local.ref(element);
                else local.ref = element;
            }
            ref = element;
        }, _el$);
        (0, $9Ue0q$insert)(_el$2, ()=>local.children, _el$3);
        (0, $9Ue0q$spread)(_el$3, (0, $9Ue0q$mergeProps)({
            get d () {
                return path();
            },
            get fill () {
        ...
        (0, $9Ue0q$effect)((_p$)=>{
            const _v$ = {
                ...
                ...local.style
            }, _v$2 = local.class, _v$3 = local.id;
...
function $090815f5086f7f29$export$2e2bcd8739ae039(props) {
    return (0, $9Ue0q$createComponent)((0, $6719f9210d2bc6ba$export$2e2bcd8739ae039), (0, $9Ue0q$mergeProps)($090815f5086f7f29$var$defaults, ()=>props.options, props));
}
